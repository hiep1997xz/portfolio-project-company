...
const twBreakpoint = tailwindConfig.theme.screens;
...
const useResponsive = () => {
  ...
  const getResponsiveState = () => {
    ...
    return {
      ...
      larger: getAllSizes('larger') as unknown as { [p in keyof typeof breakpoint]: boolean },
      smaller: getAllSizes('smaller') as unknown as { [p in keyof typeof breakpoint]: boolean }
    };
  };
